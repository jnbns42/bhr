...
function FileList() {
    ...
    return(
        <>
            <div className="bg-white sm:bg-gray-100 sm:pt-4 sm:pb-3 mb-6 border-b-2 border-gray-200">
                <div className="flex items-center">
                    <div className="sm:hidden w-18">
                        <button className="px-6 py-6 border-r-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7" />
                            </svg>
                        </button>
                    </div>
                    <div className="flex-grow bg-white rounded-md flex w-1/2 sm:w-auto space-x-3 px-4 py-2 items-center">
                        ...
                        <input type="text" name="search" className="w-3/4 sm:w-auto sm:flex-grow" value={term} placeholder="Search" onChange={e => handleChange(e.target.value)}/>
                    </div>
                    <div className="flex space-x-3 p-2 sm:py-0 sm:pl-4 sm:space-x-4">
                        <a href="#" className="rounded-full sm:bg-gray-200 block overflow-hidden">
